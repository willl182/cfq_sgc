...
with open("comp.csv", newline="", encoding="utf-8-sig") as f:
...
# === Cargar balances ===
BAL_PATH = "SGC_CALFERQUIM/08_Dossier_Productos_Registrados/_reportes_balance_masas/materias_primas_balances.csv"
bal_rows = []
...
with open("composicion_productos_resultado2.csv", "w", newline="") as f:
    writer = csv.writer(f)
...
print(f"\n\nCSV guardado: composicion_productos_resultado2.csv")

if sin_match:
    print(f"\n⚠ MPs sin match en comp.csv (no mapeadas):")
