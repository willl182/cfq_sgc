...
# Configuración
HS_DIR = Path("/home/w182/w421/cfq_sgc/202_CALFERQUIM/07 Hojas de Seguridad")
DEST_DIR = Path("/home/w182/w421/cfq_sgc/SGC_CALFERQUIM/08_Dossier_Productos_Registrados/_Indice_HS")
...
for item, info in mapeo_productos.items():
    ...
    if archivo_fuente:
        ...
        try:
            ...
            print(f"✗ Error al copiar {producto}: {e}\n")
            no_encontrados.append(item)
    else:
        print(f"✗ No se encontró HS para {producto} (Item {item})")
