...
de los productos registrados en SGC_CALFERQUIM/08_Dossier_Productos_Registrados.
...
BASE_DIR = Path(__file__).parent / "SGC_CALFERQUIM" / "08_Dossier_Productos_Registrados"
OUTPUT_CSV = Path(__file__).parent / "balance_masas_consolidado.csv"
