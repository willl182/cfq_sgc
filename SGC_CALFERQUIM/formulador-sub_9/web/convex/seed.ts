/**
 * Seed script: carga inicial del catálogo desde CSV.
 * Solo se ejecuta si catalogItems está vacío.
 * Genera IDs secuenciales: MP0001, PT0001, MZR0001
 */
...
export const clearCatalog = mutation({
  ...
  handler: async (ctx) => {
    ...
    return { eliminados: items.length };
  },
});