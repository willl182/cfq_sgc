...
### Lista de Chequeo Documental de Ingreso de MP Importada

## Instrucciones

Esta lista de chequeo **debe** completarse para cada despacho de Materia Prima Importada que ingrese a las instalaciones de **CALFERQUIM S.A.S.** en custodia de Terceros. El Jefe de Logística/Almacén es el responsable de verificar los documentos antes de la descarga.

## Lista de Verificación

| # | DOCUMENTO | CONFORME | NO CONFORME | OBSERVACIONES |
|:---:|:---|:---:|:---:|:---|
| 1 | **Declaración de Importación (DIAN)** | ☐ | ☐ | No. ________________________ |
| 2 | **Certificado de Análisis (COA)** del Proveedor | ☐ | ☐ | Fecha: ____/____/________ |
| 3 | **Lista de Empaque (Packing List)** | ☐ | ☐ | Coincide bultos físicos |
| 4 | **Hoja de Seguridad (FDS)** en español | ☐ | ☐ | Versión: __________________ |
| 5 | **Remisión del Transportador** | ☐ | ☐ | Conductor: __________________ |
| 6 | **Etiquetado GHS** visible en cada bulto/unidad | ☐ | ☐ | Pictogramas claros |
| 7 | **Contrato de Custodia/Depósito** firmado (si aplica) | ☐ | ☐ | Fecha inicio: ____/____/________ |
| 8 | **Certificado Libre Venta** (si lo requiere) | ☐ | ☐ | N/A: ☐ |
| 9 | **Registro ICA del Importador** (si lo requiere) | ☐ | ☐ | No. ________________________ |
| 10 | **Inspección de calidad física** (envases intactos) | ☐ | ☐ | Daños menores: ☐ Sí ☐ No |

## Registro

| CAMPO | DATO |
|:---|:---|
| **Fecha de Ingreso** | ____/____/________ Hora: ____:____ |
| **Cliente Tercero (Propietario)** | ____________________________ |
| **Producto** | ____________________________ |
| **Lote del Proveedor** | ____________________________ |
| **Cantidad Recibida** | ____________ kg / ____________ unidades |
| **Responsable Recepción** | ____________________________ |
| **Firma Responsable** | ____________________________ |

> **Regla:** Si falta un documento crítico (DIAN, COA, FDS), el material **no puede** ingresar a bodega principal y debe quedar en **CUARENTENA DOCUMENTAL** (Zona de Recepción) hasta regularizar la situación (máx. 48 horas).
