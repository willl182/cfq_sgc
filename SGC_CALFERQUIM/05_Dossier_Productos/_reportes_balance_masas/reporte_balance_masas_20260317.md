...
- Dossiers revisados: 58
- Balances generados: 18
- Productos con match en `comp.csv` pero sin formula en `list.csv`: 11
- Dossiers sin match confiable en `comp.csv`: 29

## Balances generados

- `05_10-30-10` -> codigo `86`; filas_formula=5; masa_total_kg=1040; masa_formulacion_kg=1000; mp_sin_comp=3; mp_ambiguas=0
- `07_15-15-15` -> codigo `85`; filas_formula=6; masa_total_kg=1040; masa_formulacion_kg=1000; mp_sin_comp=3; mp_ambiguas=0
- `09_18-18-18` -> codigo `83`; filas_formula=6; masa_total_kg=1040; masa_formulacion_kg=1000; mp_sin_comp=3; mp_ambiguas=0
- `10_25-4-24` -> codigo `82`; filas_formula=6; masa_total_kg=1040; masa_formulacion_kg=1000; mp_sin_comp=3; mp_ambiguas=0
- `15_BORO GRANULADO` -> codigo `123`; filas_formula=5; masa_total_kg=1100; masa_formulacion_kg=1100; mp_sin_comp=0; mp_ambiguas=2
- `17_CALFERCORRECTIVO` -> codigo `311`; filas_formula=8; masa_total_kg=1040; masa_formulacion_kg=1000; mp_sin_comp=2; mp_ambiguas=2
...
- `36_NUCLEO 4` -> codigo `65`; filas_formula=5; masa_total_kg=1000; masa_formulacion_kg=1000; mp_sin_comp=0; mp_ambiguas=1
...
- `49_SILIMAGRAM` -> codigo `35`; filas_formula=5; masa_total_kg=1100; masa_formulacion_kg=1100; mp_sin_comp=0; mp_ambiguas=2
- `55_SULFATO ZINC 22` -> codigo `997`; filas_formula=4; masa_total_kg=1000; masa_formulacion_kg=1000; mp_sin_comp=0; mp_ambiguas=1
- `60_BIOPLANTAS` -> codigo `393`; filas_formula=3; masa_total_kg=1040; masa_formulacion_kg=1000; mp_sin_comp=2; mp_ambiguas=0
...
- `08_17-6-18-2` -> codigo `21` / `MF-17-6-18-2`
...
- `21_CALFER MAGNESIO` -> estado `missing_comp` (sin_producto_en_comp)
...
- `37_NUCLEO CAMASI` -> estado `missing_comp` (sin_producto_en_comp)
